...
namespace EasyMicroservices.OrderingMicroservice.Clients.Tests
{
...
{""result"":[],""isSuccess"":true,""error"":null}");
        ...
        {
            //await OnInitialize();
            //var microserviceClient = new Ordering.GeneratedServices.MicroserviceClient(_routeAddress, HttpClient);
